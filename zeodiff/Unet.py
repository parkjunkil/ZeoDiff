...
# Auxiliary functions for U-Net architecture
def exists(x):
...
# A Block consist of [ convolution layer / group normalization / activation(SiLU)]
...
# Attention Block (with additonal convolution layer and group normalization)
...
class Unet(nn.Module):
	def __init__(
		...
		# layer for time-embedding processing
